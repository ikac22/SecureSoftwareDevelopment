...
VULNERABLE_COMMIT="${CWE943_VULNERABLE_COMMIT:-183e109e74e6bddd9262ca35d94d2f6988fb3502}"
MITIGATED_REF="${CWE943_MITIGATED_REF:-attack/cwe-943-nosql-service-history}"
...
create_tag "$VULNERABLE_TAG" "$vulnerable_commit" \
  "CWE-943 vulnerable experiment snapshot"
create_tag "$MITIGATED_TAG" "$mitigated_commit" \
  "CWE-943 mitigated experiment snapshot"
